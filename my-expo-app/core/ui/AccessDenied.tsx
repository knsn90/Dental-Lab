  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32, paddingTop: insets.top + 80, gap: 12 }}>
      <View style={{
        ...
        <Lock size={26} color={DS.ink[400]} strokeWidth={1.6} />
      </View>
      <Text style={{ fontSize: 17, fontWeight: '600', color: DS.ink[800], textAlign: 'center' }}>
        {t('common.accessDenied')}
      </Text>
      <Text style={{ fontSize: 13, color: DS.ink[400], textAlign: 'center', maxWidth: 320, lineHeight: 19 }}>
