...
import {
  ...
  BadgeCheck, CircleDot, ClipboardCheck, ClipboardList, ClipboardX,
  Clock, CreditCard, Crosshair,
  CloudUpload, Copy, Database,
  DatabaseZap, DollarSign, Download,
  ExternalLink, Eye, EyeOff,
  File, FileCheck, FileEdit, FileMinus, FileText, FileX,
  FlaskConical, Folder, FolderOpen,
  Gauge, Globe, Grid3x3,
  Hash, Heart, HelpCircle, Home, Hourglass,
  Image, Inbox, Info,
  Landmark, LayoutDashboard, Link, List, ListCheck, Lock, LogIn, LogOut,
  Mail, MapPin, MapPinOff, MessageCircle, MessagesSquare, Mic, MinusCircle, MoreHorizontal,
  Network,
  ...
  Pause, Save, Search, Send, Settings, Share2, Shield, ShieldAlert, ShieldCheck,
  SlidersHorizontal, Smile, Star, Stethoscope, StopCircle,
...
const ICONS: Record<string, LucideFC> = {
  ...
  'forum':                           MessageCircle,
  'microphone':                      Mic,
  'office-building-marker-outline':  Building2,
  'pause':                           Pause,
  'printer-outline':                 Printer,
  'stop-circle-outline':             StopCircle,
  'tray-outline':                    Inbox,
  'video-outline':                   PlayCircle,
