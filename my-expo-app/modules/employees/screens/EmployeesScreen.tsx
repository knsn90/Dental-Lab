    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      <View style={[s.header, { paddingHorizontal: px }]}>
        ...
        <TouchableOpacity style={s.addBtn} onPress={() => { setEditEmp(null); setFormOpen(true); }} activeOpacity={0.85}>
          <Feather name={'user-plus' as any} size={16} color="#fff" />
        ...
        <View style={[s.body, isDesktop && { flexDirection: 'row' }]}>
          ...
          <View style={s.left}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}
              ...
              <KpiCard label="Aktif Personel" value={String(activeCount)} icon="users" color="#2563EB" />
              <KpiCard label="Bu Ay Maaş" value={fmtMoney(totalSalary)} icon="dollar-sign" color="#047857" />
              <KpiCard label="Ödenmemiş" value={`${unpaidCount} kişi`} icon="alert-circle"
                color={unpaidCount > 0 ? '#EF4444' : '#64748B'} />
              <KpiCard label="Bekleyen Avans" value={fmtMoney(totalAdvances)} icon="dollar-sign" color="#B45309" />
            </ScrollView>
            ...
            >
              {filtered.length === 0 ? (
                <View style={s.empty}>
                  <Feather name={'user-x' as any} size={40} color="#CBD5E1" />
    ...
    >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 4 }}>
          ...
          {pendAdv > 0 && (
            <View style={ec.advBadge}>
              <Feather name={'dollar-sign' as any} size={10} color="#B45309" />
      ...
      <View style={{ alignItems: 'flex-end', gap: 8 }}>
        <View style={[ec.payStatus,
          ...
          <Feather
            name={(emp.current_month_paid ? 'check-circle' : 'clock') as any}
            size={12}
        ...
        <View style={{ flexDirection: 'row', gap: 4 }}>
          ...
          {emp.is_active && (
            <TouchableOpacity style={ec.iconBtn} onPress={onDeactivate}>
              <Feather name={'user-x' as any} size={14} color="#B45309" />
            </TouchableOpacity>
          )}
            ...
            <View>
              <View style={dp.sectionHeader}>
                ...
                <TouchableOpacity style={dp.sectionBtn} onPress={onSalaryAdd}>
                  <Feather name={'plus' as any} size={13} color="#2563EB" />
              ...
              {salaries.length === 0 ? (
                ...
                <View key={sal.id} style={dp.row}>
                  <View style={dp.rowIcon}>
                    <Feather name={'check-circle' as any} size={15} color="#047857" />
                  </View>
                  <View style={{ flex: 1 }}>
                  ...
                  <TouchableOpacity onPress={() => handleDelSalary(sal.id)} style={dp.delBtn}>
                    <Feather name={'trash-2' as any} size={14} color="#CBD5E1" />
                  </TouchableOpacity>
                </View>
              ))}
            </View>
            ...
            <View>
              <View style={dp.sectionHeader}>
                ...
                <TouchableOpacity style={dp.sectionBtn} onPress={onAdvAdd}>
                  <Feather name={'plus' as any} size={13} color="#B45309" />
              ...
              {advances.length === 0 ? (
                ...
                <View key={adv.id} style={[dp.row, adv.is_deducted && dp.rowDeducted]}>
                  <View style={[dp.rowIcon, { backgroundColor: adv.is_deducted ? '#F1F5F9' : '#FEF3C7' }]}>
                    <Feather
                      name={'dollar-sign' as any} size={15}
            ...
            <View style={fm.chipRow}>
              {PAY_METHODS.map(m => (
                <TouchableOpacity key={m.v}
                  ...
                  <Feather name={m.icon as any} size={13}
