  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        {step === 1 && (
          <View>
            ...
            {/* Department */}
            <Text style={[styles.sectionTitle, { marginTop: 16 }]}>Departman</Text>
            <View style={styles.optionGrid}>
              {DEPARTMENTS.map((dep) => (
                <TouchableOpacity
                  key={dep}
                  onPress={() => setField('department')(form.department === dep ? '' : dep)}
                  style={[styles.optionChip, form.department === dep && styles.optionChipActive]}
                >
                  <Text style={[styles.optionChipText, form.department === dep && styles.optionChipTextActive]}>
                    {dep}
                  </Text>
                </TouchableOpacity>
              ))}
        ...
        {step === 3 && (
          <View>
            ...
            <View style={styles.summary}>
              ...
              {form.department && <Text style={styles.summaryRow}>Departman: {form.department}</Text>}
      ...
      <View style={styles.navButtons}>
        ...
        {step < 3 ? (
          <Button onPress={handleNext} label="İleri" style={[styles.navBtn, styles.navBtnRight]} />
        ) : (
          <Button
