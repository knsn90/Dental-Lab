                ...
                {!selectedId ? (
                  <>
                    <View style={s.searchPill}>
                      <AppIcon name="search" size={14} color={isDark ? (T.ink3 as string) : "#94A3B8"} />
                      <TextInput
                        value={search}
...
const makeStyles = (T: ReturnType<typeof useMobileTokens>, isDark: boolean) => StyleSheet.create({
  ...
  title: { fontSize: 16, fontWeight: '800', color: isDark ? T.ink : '#0F172A', letterSpacing: -0.3 },
  subtitle: { fontSize: 12, color: isDark ? T.ink3 : '#64748B', marginTop: 1 },
  closeBtn: { width: 30, height: 30, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: isDark ? T.cardSoft : '#F1F5F9' },

  label: { fontSize: 10, fontWeight: '800', color: isDark ? T.ink3 : '#94A3B8', letterSpacing: 0.8, marginBottom: 6 },

  searchPill: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: isDark ? T.cardSoft : '#F1F5F9', borderRadius: 10,
    paddingHorizontal: 10, paddingVertical: 8,
    marginBottom: 8,
  },
  searchInput: { flex: 1, fontSize: 13, color: isDark ? T.ink : '#0F172A', outlineStyle: 'none' } as any,

  matList: {
    backgroundColor: isDark ? T.cardSoft : '#F8FAFC', borderRadius: 10,
    maxHeight: 240,
  },
  matRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 12, paddingVertical: 10 },
  matRowDivider: { borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: isDark ? T.hairline : '#E5E5EA' },
  matName:  { fontSize: 13, fontWeight: '700', color: isDark ? T.ink : '#0F172A' },
  matMeta:  { fontSize: 11, color: isDark ? T.ink3 : '#94A3B8', marginTop: 1 },
  matStock: { fontSize: 12, fontWeight: '700', color: isDark ? T.ink2 : '#475569' },
  empty: { fontSize: 12, color: isDark ? T.ink3 : '#94A3B8', textAlign: 'center', padding: 24 },

  selectedBox: {
    flexDirection: 'row', alignItems: 'center', gap: 10,
    backgroundColor: isDark ? 'rgba(220,38,38,0.16)' : '#FEE2E2', borderRadius: 10,
    paddingHorizontal: 12, paddingVertical: 10,
    borderWidth: 1, borderColor: '#FCA5A5',
  },
  selectedName: { fontSize: 14, fontWeight: '800', color: isDark ? '#FCA5A5' : '#7F1D1D' },
  selectedMeta: { fontSize: 11, color: isDark ? '#FCA5A5' : '#991B1B', marginTop: 2 },
  changeBtn: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, backgroundColor: isDark ? T.card : '#FFFFFF', borderWidth: 1, borderColor: '#FCA5A5' },
  changeBtnText: { fontSize: 11, fontWeight: '700', color: '#DC2626' },

  qtyRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  qtyInput: {
    flex: 1, paddingHorizontal: 12, paddingVertical: 10,
    borderRadius: 10, borderWidth: 1, borderColor: isDark ? T.hairline : '#E2E8F0',
    fontSize: 16, fontWeight: '800', color: isDark ? T.ink : '#0F172A',
    backgroundColor: isDark ? T.cardSoft : '#F8FAFC',
    outlineStyle: 'none',
  } as any,
  qtyInputBad: { borderColor: '#FCA5A5', backgroundColor: isDark ? 'rgba(220,38,38,0.14)' : '#FEF2F2', color: '#DC2626' },
  qtyUnit: { fontSize: 13, fontWeight: '700', color: isDark ? T.ink3 : '#64748B' },
  ...
  reasonChip: {
    ...
    borderRadius: 999, borderWidth: 1, borderColor: isDark ? T.hairline : '#E5E5EA',
    backgroundColor: isDark ? T.cardSoft : '#FFFFFF',
  },
  reasonChipActive: { backgroundColor: '#0F172A', borderColor: '#0F172A' },
  reasonChipText:        { fontSize: 11, fontWeight: '600', color: isDark ? T.ink2 : '#475569' },
  reasonChipTextActive:  { color: '#FFFFFF', fontWeight: '700' },
  reasonInput: {
    backgroundColor: isDark ? T.cardSoft : '#F8FAFC', borderRadius: 10,
    borderWidth: 1, borderColor: isDark ? T.hairline : '#E2E8F0',
    paddingHorizontal: 12, paddingVertical: 10,
    fontSize: 13, color: isDark ? T.ink : '#0F172A',
  ...
  cancelBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: isDark ? T.cardSoft : '#F1F5F9', alignItems: 'center', justifyContent: 'center' },
  cancelText: { fontSize: 13, fontWeight: '700', color: isDark ? T.ink2 : '#475569' },
