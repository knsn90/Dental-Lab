-- create_purchase_invoice RPC içinde v_item_id text olarak declare edilmiş,
-- ama stock_movements.item_id UUID. Cast eksikliği "type uuid but expression
-- is of type text" hatası veriyor. RPC'yi yeniden tanımla — v_item_id'yi
-- INSERT/UPDATE sırasında uuid'ye cast et.
