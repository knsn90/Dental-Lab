-- create_purchase_invoice RPC'yi güncelle: line.brand ve line.category alanlarını
-- destekle. Yeni item oluşturulurken brand/category de set edilir. Eğer brands
-- veya categories tablolarında bu isim yoksa otomatik insert.
  ...
  LOOP
    ...
    IF v_item_id IS NULL THEN
      ...
      IF v_existing_item_id IS NOT NULL THEN
        ...
        -- Mevcut item: brand/category boşsa fatura satırından doldur (override etme)
        IF v_brand_name IS NOT NULL THEN
          UPDATE public.stock_items
          SET brand = v_brand_name
