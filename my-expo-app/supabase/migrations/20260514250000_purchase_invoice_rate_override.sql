-- create_purchase_invoice RPC: opsiyonel p_exchange_rate parametresi.
-- Faturada belirtilen kur varsa onu kullan; yoksa lab'ın currency_rates tablosundan al.
...
CREATE OR REPLACE FUNCTION public.create_purchase_invoice(
  ...
  p_notes           text,
  p_lines           jsonb,
  p_exchange_rate   numeric DEFAULT NULL    -- kullanıcının girdiği/OCR'dan gelen kur
)
RETURNS uuid AS $$
DECLARE
...
BEGIN
  ...
  -- Kur seçimi: kullanıcı girdiyse onu kullan, yoksa lab tablosundan oku.
